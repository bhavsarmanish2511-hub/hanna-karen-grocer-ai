...
export const GroceryList = ({ onDeepDive }: { onDeepDive?: () => void }) => {
    ...
    <Card className="bg-gradient-card border-border/50 shadow-glow transition-all duration-300 hover:shadow-neon cursor-pointer group" onClick={onDeepDive}>
      <div className="p-6">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h2 className="text-2xl font-bold text-foreground group-hover:text-neon-purple transition-colors">AI Grocery List</h2>
            <p className="text-muted-foreground flex items-center gap-1 group-hover:text-neon-purple/70 transition-colors">
              <Bot className="h-3 w-3" />
              Generated by Karen • Click to explore
            </p>
          </div>
        </div>
